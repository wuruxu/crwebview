...
import org.chromium.android_crwebview.webkit.WebView.HitTestResult;
import org.chromium.android_crwebview.webkit.WebView.PictureListener;
...
public interface WebViewProvider {
    ...
    public default void setTextClassifier(TextClassifier textClassifier) {}
    ...
    interface ViewDelegate {
        ...
        default void onCreateVirtualViewTranslationRequests(
                @SuppressWarnings("unused") long[] virtualIds,
                @SuppressWarnings("unused") int[] supportedFormats,
                @SuppressWarnings("unused")
        ...
        default void dispatchCreateViewTranslationRequest(
                @SuppressWarnings("unused") Map<AutofillId, long[]> viewIds,
                @SuppressWarnings("unused") int[] supportedFormats,
                @SuppressWarnings("unused") TranslationCapability capability,
                @SuppressWarnings("unused") List<ViewTranslationRequest> requests) {
