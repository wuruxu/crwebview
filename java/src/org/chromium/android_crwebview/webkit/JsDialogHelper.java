...
public class JsDialogHelper {
    ...
    public void showDialog(Context context) {
        ...
        if (mType == UNLOAD) {
            title = "crWebView Xtitle"; //context.getString(com.android.internal.R.string.js_dialog_before_unload_title);
            displayMessage = "crWebView XdisplayMessage "; //context.getString(com.android.internal.R.string.js_dialog_before_unload, mMessage);
            positiveTextId = android.R.string.ok; //"Xokay"; //com.android.internal.R.string.js_dialog_before_unload_positive_button;
            negativeTextId = android.R.string.cancel; //"Xcancel"; //com.android.internal.R.string.js_dialog_before_unload_negative_button;
        } else {
        ...
        //builder.setTitle("crWebView Xtitle");
    ...
    private String getJsDialogTitle(Context context) {
        ...
        if (URLUtil.isDataUrl(mUrl)) {
            ...
            title = "crWebView Ytitle"; //context.getString(com.android.internal.R.string.js_dialog_title_default);
        } else {
            try {
                URL alertUrl = new URL(mUrl);
                // For example: "The page at 'http://www.mit.edu' says:"
                title = "crWebView Ztitle " + alertUrl.getHost(); //context.getString(com.android.internal.R.string.js_dialog_title, alertUrl.getProtocol() + "://" + alertUrl.getHost());
