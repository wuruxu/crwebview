...
import org.chromium.android_crwebview.webkit.MyDrawFunctor;
...
public class WebView extends AbsoluteLayout
    ...
    private static class HardwareView extends SurfaceView implements SurfaceHolder.Callback {
        ...
        private final MyDrawFunctor mDrawFunctor;

        public HardwareView(Context context, Looper mWebViewThread) {
            super(context);
            if (sRenderThread == null) {
                ...
                sRenderThreadHandler = new Handler(mWebViewThread);
            }
            mDrawFunctor = new MyDrawFunctor();
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            Log.i("crWebView", " surfaceChanged  called mHardwareView = " + this);
            if (holder == mOverlaysSurfaceView.getHolder()) {
                Surface surface = holder.getSurface();
                //sRenderThreadHandler.post(
                ThreadUtils.postOnUiThread(
                        () -> {
                            mDrawFunctor.setOverlaysSurface(surface);
                        });
                return;
            }
            ...
            Log.i("crWebView", "surfaceChanged setSurface width " + width + " height " + height + " this " + this);
            Surface surface = holder.getSurface();
            //sRenderThreadHandler.post(
            ThreadUtils.postOnUiThread(
                    () -> {
                        mDrawFunctor.setSurface(surface, width, height);
                    });
        }
        ...
        public void surfaceDestroyed(SurfaceHolder holder) {
            if (holder == mOverlaysSurfaceView.getHolder()) {
                ...
                ThreadUtils.postOnUiThread(
                        () -> {
                            mDrawFunctor.setOverlaysSurface(null);
                            //event.signal();
                        });
                //event.waitForEvent();
                return;
            ...
            Log.i("crWebView", "surfaceDestroyed setSurface null 0 0 this = " + this);
            mHaveSurface = false;
            //WaitableEvent event = new WaitableEvent();
            //sRenderThreadHandler.post(
            ...
            ThreadUtils.postOnUiThread(
                    () -> {
                        mDrawFunctor.setSurface(null, 0, 0);
                        //event.signal();
                    });
            //event.waitForEvent();
        }
        ...
        public void drawWebViewFunctor(int functor) {
            ...
            Log.i("crWebView", " *** drawWebViewFunctor functor " + functor + " mHaveSurface " + mHaveSurface);
            //WaitableEvent syncEvent = new WaitableEvent();
            //ThreadUtils.getUiThreadHandler().post(
            ThreadUtils.postOnUiThread(
                    () -> {
                        //drawOnRt(syncEvent, functor, mWidth, mHeight, mLastScrollX, mLastScrollY);
                        Log.i("crWebView", " ** drawOnRt sync functor " + functor + " mHardwareView " + this);
                        mDrawFunctor.sync(functor, false);
                        //syncEvent.signal();
                        mDrawFunctor.draw(mWidth, mHeight, mLastScrollX, mLastScrollY, /* readbackQuadrants= */ false);
                    });
    ...
    protected WebView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        Log.i("crWebView", " ** WebView instance created called ** ");
        ...
        mHardwareView = new HardwareView(context, mWebViewThread);
        ...
        Log.i("crWebView", "WebView *xy3* addView mHardwareView " + mHardwareView + " Application Context " +  context.getApplicationContext());
    }
   ...
   /**
    ...
    public void loadUrl(String url, Map<String, String> additionalHttpHeaders) {
        Log.i("crWebView", "*loadUrl STEP 001 url " + url);
        checkThread();
    ...
    public void loadUrl(String url) {
        Log.i("crWebView", "*loadUrl STEP 002 url " + url);
        checkThread();
    ...
    public void postUrl(String url, byte[] postData) {
        Log.i("crWebView", "*postUrl STEP 003 url " + url);
        checkThread();
     ...
     */
    public void loadData(String data, String mimeType,
            String encoding) {
        Log.i("crWebView", "*loadData STEP 001 data " + data);
        checkThread();
    ...
    public void loadDataWithBaseURL(String baseUrl, String data,
        ...
        Log.i("crWebView", "*loadDataWithBaseURL STEP 001 baseUrl " + baseUrl + " data " + data);
        checkThread();
     ...
     */
    public void evaluateJavascript(String script, ValueCallback<String>
            resultCallback) {
        Log.i("crWebView", "*evaluateJavascript STEP 001 script " + script);
        checkThread();
    ...
    public class PrivateAccess {
        ...
        public boolean super_performAccessibilityAction(int action, Bundle arguments) {
			Log.i("crWebView", "super_performAccessibilityAction called");
			return false;
        ...
        public boolean super_setFrame(int left, int top, int right, int bottom) {
			Log.i("crWebView", " super_setFrame called");
			return false;
        ...
        public void super_startActivityForResult(Intent intent, int requestCode) {
			Log.i("crWebView", "super_startActivityForResult called");
        }
        ...
        public void overScrollBy(int deltaX, int deltaY,
            ...
            WebView.super.overScrollBy(deltaX, deltaY, scrollX, scrollY, scrollRangeX, scrollRangeY,
                    maxOverScrollX, maxOverScrollY, isTouchEvent);
        }

        public void awakenScrollBars(int duration) {
            WebView.super.awakenScrollBars(duration);
        }
        ...
        public float getVerticalScrollFactor() {
			Log.i("crWebView", " getVerticalScrollFactor called, return 1.0f");
            return 1.0f; //WebView.this.getVerticalScrollFactor();
        }

        public float getHorizontalScrollFactor() {
			Log.i("crWebView", "getHorizontalScrollFactor called, return 1.0f");
            return 1.0f; //WebView.this.getHorizontalScrollFactor();
        }
        ...
        public void super_onDrawVerticalScrollBar(Canvas canvas, Drawable scrollBar,
			...
			Log.i("crWebView", "super_onDrawVerticalScrollBar called");
        ...
        public void setScrollXRaw(int scrollX) {
			Log.i("crWebView", "setScrollXRaw called scrollX = " + scrollX);
        ...
        public void setScrollYRaw(int scrollY) {
			Log.i("crWebView", "setScrollYRaw called scrollY = " + scrollY);
    ...
    */
    ...
    public static PackageInfo getCurrentWebViewPackage() {
		Log.i(LOGTAG, "getCurrentWebViewPackage return null");
		return null;
    }
