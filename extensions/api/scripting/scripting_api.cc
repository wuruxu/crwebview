...
#include "android_webview/crwebview/extensions/api/scripting/scripting_api.h"
...
bool CanAccessTarget(const PermissionsData& permissions,
  ...
  //  return false;
  //}
  LOG(INFO) << "CanAccessTarget ignore GetTabById "<< target.tab_id;
  ...
  *script_executor_out = nullptr; //script_executor;
  return true;
}
