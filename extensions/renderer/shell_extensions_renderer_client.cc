...
#include "android_webview/crwebview/extensions/renderer/shell_extensions_renderer_client.h"
...
void ShellExtensionsRendererClient::OnExtensionLoaded(const Extension& extension) {
  LOG(INFO) << "* ShellExtensionsRendererClient OnExtensionLoaded " << extension.id();
}

void ShellExtensionsRendererClient::OnExtensionUnloaded(const ExtensionId& extension) {
  LOG(INFO) << "* ShellExtensionsRendererClient OnExtensionUnloaded " << extension;
}
